...
struct BOARD_PIN cybercamK230_pins[] = {
    ...
    DEF_A_BOARD_PIN(17, 21, "KEY/21", PH_COLOR_GREEEN),
    DEF_A_BOARD_PIN(18, 52, "LED/52", PH_COLOR_GREEEN),
    DEF_A_BOARD_PIN(19, 46, "LIGHT/46", PH_COLOR_GREEEN),
    DEF_A_BOARD_PIN(20, 47, "BEEP/47", PH_COLOR_GREEEN),
};
